...
const ContactSection = () => {
    return (
        <>
           ...
           <ContactH3>Welke weg wil jij bewandelen? Neem vrijblijvend contact met me op via:</ContactH3>
            <ContactWrapper>
                <ContactCard>
                    <ContactIcon src={Icon5}/>
                    <ContactH2>E-mail:</ContactH2>
                    <ContactP>claudiawenner67@gmail.com</ContactP>
                </ContactCard>
               
                <ContactCard>
                    <ContactIcon src={Icon4}/>
                    <ContactH2>Telefoon:</ContactH2>
                    <ContactP>06-10279466</ContactP>
                </ContactCard>
                </ContactWrapper>
                    <BtnWrapper>
