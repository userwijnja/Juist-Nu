...
import Icon3 from "../../images/bloesemremedie.gif";
...
const Services = () => {
  return (
    <ServicesContainer id="werkwijze">
      ...
      <ServicesP>
        Ik ondersteun vrouwen tussen de 25 en 95 jaar om zich van een leven
        waarin ze zichzelf steeds voorbij lopen, naar een energiek bestaan in
        balans te ontwikkelen. Dit doe ik onder andere als wandelcoach
        doormiddel van groepswandelingen en eetbare wildplanten- en
        kruidenwandelingen. Hiernaast ben ik bekend met de volgende technieken:
      </ServicesP>
      <ServicesWrapper>
        <ServicesCard>
        ...
        <ServicesCard>
          ...
          <ServicesH2>
            Het gebruik van kruiden ten behoeve van je gezondheid
          </ServicesH2>
        </ServicesCard>
      ...
      <ServicesWrapper>
        ...
        <SmallP>
          *foto van Nederlandse Bloesem Remedies. www.bloesemremedies.com
        </SmallP>
      </ServicesWrapper>
    </ServicesContainer>
  );
